package es.projectalpha.wcc.core.utils;
...
public class Utils {
    ...
    private WCCCore plugin;

    public Utils(WCCCore instance) {
        plugin = instance;
    }
    ...
    public static void sendAdminMsg(WCCUser user, String msg){
        WCCServer.getUsers().forEach(u -> {
